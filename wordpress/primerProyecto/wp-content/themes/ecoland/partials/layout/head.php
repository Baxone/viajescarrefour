<head>
    ...
    <link rel="stylesheet" href="<?= get_template_directory_uri() ?>/css/open-iconic-bootstrap.min.css">
    ...
    <link rel="stylesheet" href="<?= get_template_directory_uri() ?>/css/ionicons.min.css">
